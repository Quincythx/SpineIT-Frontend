...
export function SavedPage() {
  ...
  if (!user) {
    return (
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-16 py-12 lg:py-24 flex justify-center">
        <div className="max-w-[900px] w-full bg-white border border-[#eae7e7] rounded-lg shadow-[0px_4px_20px_0px_rgba(0,70,74,0.05)] flex overflow-hidden">
          <div className="flex-1 bg-[#f6f3f2] hidden md:block">
          ...
          <div className="flex-1 p-6 sm:p-16 flex flex-col items-start justify-center gap-6">
            ...
            <h1 className="font-['Playfair_Display'] font-bold text-3xl sm:text-4xl lg:text-5xl leading-tight lg:leading-[60px] text-[#00464a] tracking-[-1.2px]">
              Your Personal Curation Awaits
            </h1>
            <p className="font-['Inter'] text-lg text-[#3f4949] leading-[29px]">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
              ...
              <Link to="/login" className="font-['Inter'] font-semibold text-sm tracking-[0.7px] text-[#00464a] underline">
                Log In
              </Link>
            </div>
          </div>
  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-16 py-8 lg:py-12 flex flex-col gap-8 lg:gap-12">
      <div className="border-b border-[#bec8c9] pb-6 flex flex-col gap-3">
        ...
        <p className="font-['Inter'] text-lg text-[#3f4949]">Your personal curation of community insights.</p>
      </div>

      <div className="flex flex-col md:flex-row gap-6 items-stretch flex-wrap">
        {items === null && <p className="font-['Inter'] text-[#3f4949]">Loading…</p>}
        {items?.length === 0 && (
